...
module ctrl(Op, Funct7, Funct3, Zero, 
 ...
 // i format load 0000011
  ...
  assign ALUSrc     = itype_r | LUI | itype_l | stype | i_jalr; // jal 走NPC自带的加法运算   // ALU B is from instruction immediate
...
// ALUOp_nop 5'b00000
// ALUOp_lui 5'b00001
// ALUOp_add 5'b00011 jalr会使用加法运算，所以jalr也使用这个op码
// ALUOp_sub 5'b00100
// ALUOp_xor 5'b01100
// ALUOp_or 5'b01101
// ALUOp_and 5'b01110
...
// `define ALUOp_sltu 5'b01011
    ...
    assign ALUOp[3] = i_and | i_or | i_sll | i_xor | i_slt | i_sltu | i_bltu | i_bgeu | i_slti | i_sltui | i_andi | i_xori | i_ori | i_slli;
    assign ALUOp[2] = i_and | i_andi | i_or | i_ori | i_sub | i_beq | i_sll | i_slli | i_xor | i_xori | i_bne | i_blt | i_bge;
    assign ALUOp[1] = i_addi | i_add | i_and | i_andi | i_sll | i_slli | itype_l | stype | i_blt | i_bge | i_slt | i_slti | i_sltu | i_sltui | i_jalr;
	  assign ALUOp[0] = i_addi | i_add | i_or | i_ori | LUI | i_sll | i_slli | i_sra | i_srai | itype_l | stype | i_bne | i_bge | i_bgeu | i_sltu | i_sltui | i_jalr;
